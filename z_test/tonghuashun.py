...
def datepool_basicdata_demo():
    ...
    data_codes = THS_DR(
        "p03291",
        "date=20250514;blockname=001005010;iv_type=allcontract",
    ...
    if data_codes.errorcode != 0:
        ...
        data_result = THS_BD(
            seccode_codes_list, "ths_close_price_stock", "2025-05-14,100"
        )
...
def datapool_realtime_demo():
    ...
    data_sz50 = THS_DR(
        "p03291",
        "date=" + today_str + ";blockname=001005260;iv_type=allcontract",
        "p03291_f001:Y,p03291_f002:Y,p03291_f003:Y,p03291_f004:Y",
    )
...
def multiThread_demo():
    ...
    data_alla = THS_DR(
        "p03291",
        "date=" + today_str + ";blockname=001005010;iv_type=allcontract",
        "p03291_f001:Y,p03291_f002:Y,p03291_f003:Y,p03291_f004:Y",
    )
    ...
    l = []
    for eachlist in [
        stock_list[i : i + int(len(stock_list) / 10)]
        for i in range(0, len(stock_list), int(len(stock_list) / 10))
    ]:
