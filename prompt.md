...
└── data
    ...
    └── 2013
        ...
        └── SH.600004.csv
```
某个 csv 文件数据样例如下,其包含了该股票这一年的分钟级别交易数据:
```
              datetime  open  high   low  close  volume
0  2012-01-04 09:31:00  8.54  8.54  8.54   8.54    3394
1  2012-01-04 09:32:00  8.54  8.54  8.52   8.53    1419
2  2012-01-04 09:33:00  8.52  8.53  8.51   8.53    3198
...
38638  2012-08-29 14:59:00  40.50  40.50  40.50  40.50     0.0   
38639  2012-08-29 15:00:00  40.50  40.50  40.50  40.50   887.0 
...
```
事实:
1. 现实世界中的股票市场是一个动态集合。
...
输入被定义为 $\mathcal{X} \in \mathbb{R}^{N \times T \times F}$ 。
$N$: 股票数量。
...
假设我输入目录`quantitative_log/data/2012`,怎么自动处理整个数据使其做好`零填充 + 掩码 (Zero+Mask)`使得之后方便我输入$\mathcal{X}$制作模型训练的dataset
